...
var chart1;
            ...
            AmCharts.ready(function () {
                ...
                graph.balloonText = "<img src='../vendor/amCharts/images/car.png' style='vertical-align:bottom; margin-right: 10px; width:28px; height:21px;'><span style='font-size:14px; color:#000000;'><b>[[value]]</b></span>";
                graph.hidden = true;
                ...
                graph.balloonText = "<img src='../vendor/amCharts/images/motorcycle.png' style='vertical-align:bottom; margin-right: 10px; width:28px; height:21px;'><span style='font-size:14px; color:#000000;'><b>[[value]]</b></span>";
                chart.addGraph(graph);
                ...
                graph.lineAlpha = 0;
                graph.fillAlphas = 0.6;
                graph.balloonText = "<img src='../vendor/amCharts/images/bicycle.png' style='vertical-align:bottom; margin-right: 10px; width:28px; height:21px;'><span style='font-size:14px; color:#000000;'><b>[[value]]</b></span>";
                chart.addGraph(graph);
...
var chart2;
 ...
 var chart3;
			...
			AmCharts.ready(function () {
				...
				axis.endValue = 12;
				axis.color ="#ffffff";
				axis.titleColor ="#ffffff";
				axis.axisColor ="#ffffff";
				axis.valueInterval = 1;
				axis.minorTickInterval = 0.4;
				...
				axis2.axisColor ="#ffffff";
                axis2.titleColor ="#ffffff";
				axis2.startAngle = 0;
				axis2.endAngle = 360;
				axis2.radius = 40;
				axis2.centerY = 80;
...
// note, each data item has "bullet" field.
            var columnChartData5 = [
                {
                    "name": "John",
                    "points": 35654,
                    "color": "#7F8DA9",
                    "bullet": "../vendor/amCharts/images/0.gif"
                },
                {
                    "name": "Damon",
                    "points": 65456,
                    "color": "#FEC514",
                    "bullet": "../vendor/amCharts/images/1.gif"
                },
                {
                    "name": "Patrick",
                    "points": 45724,
                    "color": "#DB4C3C",
                    "bullet": "../vendor/amCharts/images/2.gif"
                },
                {
                    "name": "Mark",
                    "points": 13654,
                    "color": "#DAF0FD",
                    "bullet": "../vendor/amCharts/images/3.gif"
                }
            ];
            ...
            AmCharts.ready(function () {
                ...
                chart.dataProvider = columnChartData5;
