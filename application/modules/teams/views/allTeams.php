    ...
    <style type="text/css">
      ...
      $.get("<?php echo base_url()?>teams/all_teams_ajax", query_string, panel_data);
      ...
      $(document).on('click', '.fa-trash', function(e){
        ...
        id = $(this).attr('value');
        name = $(this).attr('name');
        query_string = 'team_id=' + id;

          $('<div><div>').html("are you sure you want to delete '" + name + "' Team ?").dialog({
          buttons : {
            "sure" : function() {
              $.get("<?php echo base_url()?>teams/make_inactive", query_string, feedback);
              $(this).dialog('close');
              ...
              function feedback(data){
                ...
                alerts(message, 'Team Delete Status');
...
<div class="container-fluid">
    ...
    <div class="col-md-10 col-md-offset-1 co-xs-12 col-sm-12">
      ...
      <li class="active"><?php echo " Manage Teams" ;?></li>
    </ol>
    </div>
  </div>
  
  <div class="row">
    <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-12">

      <?php        

          $this->load->module('templates');
          echo $this->templates->adv_top('TEAMS',  'Teams', false);
        ?>
        <div id='panel_data'>
