    ...
    $.get("<?php echo base_url(); ?>zones/all_zones_ajax", query_string, panel_data);
    ...
    $(document).on('click', '.nav_next a', function(e){
      ...
      $.get("<?php echo base_url(); ?>zones/all_zones_ajax", query_string, panel_data)
        ...
        $(document).on('click', '.fa-trash', function(e){
          ...
          id = $(this).attr('value');
          name = $(this).attr('name');
          query_string = 'zone_id=' + id;

            $('<div><div>').html("are you sure you want to delete '" + name + "' zone ?").dialog({
            buttons : {
              "sure" : function() {
                $.get("<?php echo base_url()?>zones/make_inactive", query_string, feedback);
                $(this).dialog('close');
                ...
                function feedback(data){
                  ...
                  alerts(message, 'Zone delete status');
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1 col-xs-12 col-sm-12">
      ...
      <li><a href="<?php echo base_url() ;?>communities/">communities</a></li>
      <li><a href="<?php echo base_url() ;?>zones/">Zones</a></li>
      <li class="active"><?php echo "Manage Zones" ;?></li>
    </ol>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
      <?php 
          ...
          echo $this->templates->adv_top('Zones', 'Zones', false);
        ?>
        <div id='panel_data'>
