    ...
    $.get("<?php echo base_url(); ?>small_groups/all_small_groups_ajax", query_string, panel_data);
    ...
    $(document).on('click', '.nav_next a', function(e){
      ...
      $.get("<?php echo base_url(); ?>small_groups/all_small_groups_ajax", query_string, panel_data)
        ...
        $(document).on('click', '.fa-trash', function(e){
          ...
          id = $(this).attr('value');
          name = $(this).attr('name');
          query_string = 'sg_id=' + id;

            $('<div><div>').html("are you sure you want to drop small Group '" + name + "' ?").dialog({
            buttons : {
              "sure" : function() {
                $.get("<?php echo base_url()?>small_groups/make_inactive", query_string, feedback);
                $(this).dialog('close');
                ...
                function feedback(data){
                  if(data == false)
                    ...
                    $('#tr_'+ id).remove();
                    message = "Small  Group successfully deleted";
                  }                    
                   else
                    message = 'Fatal Error! conatct admin!'

                  alerts(message, 'Small Group Delete Status');
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1 col-xs-12 col-sm-12">
      ...
      <li class="active">All Small Groups</li>
    </ol>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
      <?php 
          ...
          echo $this->templates->adv_top('Small Groups', 'small Groups', false);
        ?>
        <div id='panel_data'>
