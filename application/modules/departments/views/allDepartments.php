    ...
    $.get("<?php base_url() ;?>departments/all_departments_ajax", query_string, panel_data);
    ...
    $(document).on('click', '.nav_next a', function(e){
      ...
      $.get("<?php base_url() ;?>departments/all_departments_ajax", query_string, panel_data)
        ...
        $(document).on('click', '.fa-trash', function(e){
          ...
          id = $(this).attr('value');
          name = $(this).attr('name');
          query_string = 'department_id=' + id;

            $('<div><div>').html("are you sure you want to delete '" + name + "' department ?").dialog({
            buttons : {
              "sure" : function() {
                $.get("<?php echo base_url()?>departments/make_inactive", query_string, feedback);
                $(this).dialog('close');
                ...
                function feedback(data){
                  ...
                  alerts(message, 'Department Delete Status');
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1 col-xs-12 col-sm-12">
      ...
      <li class="active"><?php echo "Manage Departments" ;?></li>
    </ol>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
      ...
      <?php 
          ...
          echo $this->templates->adv_top('Departmens',  'departments', false);
        ?>
        <div id='panel_data'>
